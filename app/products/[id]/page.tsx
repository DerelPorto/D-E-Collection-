...
export default function ProductDetail({ params }: { params: { id: string } }) {
  ...
  //   const message = `Hola, quiero confirmar el PRE-ORDER de: *${product.name}*.`;
  //   window.open(
  ...
  const handleAddToCart = () => {
    ...
    // Opcional: Si quieres que se abra el carrito solo al agregar, ya lo hace el context.
    // Si quieres forzarlo o mostrar un mensaje, puedes hacerlo aquí.
  };
